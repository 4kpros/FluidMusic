package com.prosabdev.common.sharedprefs
...
private const val SHARED_PREF_KEY = "${ConstantValues.PACKAGE_NAME}.SHARED_PREF_KEY"
abstract class SharedPreferenceManagerUtils {
    class Player {
        companion object {
            ...
            private const val PLAYER_CURRENT_PLAYING_SONG = "PLAYER_CURRENT_PLAYING_SONG"
            ...
            fun loadCurrentPlayingSong(ctx: Context, sharedPreferences: SharedPreferences? = null): SongItem? {
                if(sharedPreferences != null){
                    ...
                    val tempItem: String? = sharedPreferences.getString(
                        PLAYER_CURRENT_PLAYING_SONG, null)
                ...
                val tempItem: String? = tempSP.getString(
                    PLAYER_CURRENT_PLAYING_SONG, null)
                val tempItemType = object : TypeToken<SongItem>() {}.type
                return tempGson.fromJson<SongItem>(tempItem, tempItemType)
            }
            fun saveCurrentPlayingSong(ctx: Context, value: SongItem?) {
                ...
                tempEditor.putString(PLAYER_CURRENT_PLAYING_SONG, tempJson)
                tempEditor.apply()
            }
            ...
            fun loadSleepTimer(ctx: Context, sharedPreferences: SharedPreferences? = null): SleepTimerSP? {
                ...
                val tempItem: String? = tempSP.getString(PLAYER_SLEEP_TIMER, null)
                val tempItemType = object : TypeToken<SleepTimerSP>() {}.type
                return tempGson.fromJson<SleepTimerSP>(tempItem, tempItemType)
            }
            ...
            fun loadRepeat(ctx: Context, sharedPreferences: SharedPreferences? = null): Int {
                return loadIntValue(ctx, PLAYER_REPEAT, PlaybackStateCompat.REPEAT_MODE_NONE, sharedPreferences)
            }
            fun saveRepeat(ctx: Context, value: Int?) {
                saveIntValue(ctx, value ?: PlaybackStateCompat.REPEAT_MODE_NONE, PLAYER_REPEAT)
            }
            //Shuffle
            fun loadShuffle(ctx: Context, sharedPreferences: SharedPreferences? = null): Int {
                return loadIntValue(ctx, PLAYER_SHUFFLE, PlaybackStateCompat.SHUFFLE_MODE_NONE, sharedPreferences)
            }
            fun saveShuffle(ctx: Context, value: Int?) {
                saveIntValue(ctx, value ?: PlaybackStateCompat.SHUFFLE_MODE_NONE, PLAYER_SHUFFLE)
            }
            //Queue list source
            fun loadQueueListSource(ctx: Context, defaultValue: String?, sharedPreferences: SharedPreferences? = null): String? {
                return loadStringValue(ctx, PLAYER_QUEUE_LIST_SOURCE, defaultValue, sharedPreferences)
            }
            fun saveQueueListSource(ctx: Context, value: String?) {
                saveStringValue(ctx, value, PLAYER_QUEUE_LIST_SOURCE)
            }
            //Queue list size
            fun loadPlayingProgressValue(ctx: Context, sharedPreferences: SharedPreferences? = null): Long {
                return loadLongValue(ctx, PLAYER_PLAYING_PROGRESS_VALUE, 0, sharedPreferences)
            }
            fun savePlayingProgressValue(ctx: Context, value: Long?) {
                saveLongValue(ctx, value ?: 0, PLAYER_PLAYING_PROGRESS_VALUE)
            }
            //Queue list source value
            fun loadQueueListSourceColumnIndex(ctx: Context, sharedPreferences: SharedPreferences? = null): String? {
                return loadStringValue(ctx, PLAYER_QUEUE_LIST_SOURCE_COLUMN_INDEX, null, sharedPreferences)
            }
            fun saveQueueListSourceColumnIndex(ctx: Context, value: String?) {
                saveStringValue(ctx, value, PLAYER_QUEUE_LIST_SOURCE_COLUMN_INDEX)
            }
            //Queue list source value
            fun loadQueueListSourceColumnValue(ctx: Context, sharedPreferences: SharedPreferences? = null): String? {
                return loadStringValue(ctx, PLAYER_QUEUE_LIST_SOURCE_COLUMN_VALUE, null, sharedPreferences)
            }
            fun saveQueueListSourceColumnValue(ctx: Context, value: String?) {
                saveStringValue(ctx, value, PLAYER_QUEUE_LIST_SOURCE_COLUMN_VALUE)
            }
        }
    }
    ...
    class AudioEffects {
        companion object {
            ...
            fun loadEqualizerPresetName(ctx: Context): String? {
                return loadStringValue(ctx, AUDIO_EFFECTS_DEFAULT_EQUALIZER_PRESET_NAME, null, null)
            }
            fun saveEqualizerPresetName(ctx: Context, value: String?) {
                saveStringValue(ctx, value, AUDIO_EFFECTS_DEFAULT_EQUALIZER_PRESET_NAME)
            }
            ...
            fun loadBassBoostProgress(ctx: Context): Int {
                return loadIntValue(ctx, AUDIO_EFFECTS_BASS_PROGRESS, 0, null)
            }
            fun saveBassBoostProgress(ctx: Context, value: Int) {
                saveIntValue(ctx, value, AUDIO_EFFECTS_BASS_PROGRESS)
            }
            //VISUALIZER PROGRESS
            fun loadVisualizerProgress(ctx: Context): Int {
                return loadIntValue(ctx, AUDIO_EFFECTS_VISUALIZER_PROGRESS, 0, null)
            }
            fun saveVisualizerProgress(ctx: Context, value: Int) {
                saveIntValue(ctx, value, AUDIO_EFFECTS_VISUALIZER_PROGRESS)
            }
            //BALANCE PROGRESS
            fun loadBalanceProgress(ctx: Context): Int {
                return loadIntValue(ctx, AUDIO_EFFECTS_BALANCE_PROGRESS, 0, null)
            }
            fun saveBalanceProgress(ctx: Context, value: Int) {
                saveIntValue(ctx, value, AUDIO_EFFECTS_BALANCE_PROGRESS)
            }
            //REVERB PROGRESS
            fun loadReverbProgress(ctx: Context): Int {
                return loadIntValue(ctx, AUDIO_EFFECTS__REVERB_PROGRESS, 0, null)
            }
            fun saveReverbProgress(ctx: Context, value: Int) {
                saveIntValue(ctx, value, AUDIO_EFFECTS__REVERB_PROGRESS)
            }
            //LOUDNESS ENHANCER PROGRESS
            fun loadLoudnessEnhancerProgress(ctx: Context): Int {
                return loadIntValue(ctx, AUDIO_EFFECTS_LOUDNESS_ENHANCER_PROGRESS, 0, null)
            }
            fun saveLoudnessEnhancerProgress(ctx: Context, value: Int) {
                saveIntValue(ctx, value, AUDIO_EFFECTS_LOUDNESS_ENHANCER_PROGRESS)
            }
            ...
            fun loadEqualizerState(ctx: Context): Boolean {
                return loadBooleanValue(ctx, AUDIO_EFFECTS_ENABLE_EQUALIZER, false, null)
            }
            fun saveEqualizerState(ctx: Context, value: Boolean) {
                saveBooleanValue(ctx, value, AUDIO_EFFECTS_ENABLE_EQUALIZER)
            }
            //TONE STATE SETTING
            fun loadToneState(ctx: Context): Boolean {
                return loadBooleanValue(ctx, AUDIO_EFFECTS_ENABLE_TONE, false, null)
            }
            fun saveToneState(ctx: Context, value: Boolean) {
                saveBooleanValue(ctx, value, AUDIO_EFFECTS_ENABLE_TONE)
            }
            //BALANCE STATE SETTING
            fun loadBalanceState(ctx: Context): Boolean {
                return loadBooleanValue(ctx, AUDIO_EFFECTS_ENABLE_BALANCE, false, null)
            }
            fun saveBalanceState(ctx: Context, value: Boolean) {
                saveBooleanValue(ctx, value, AUDIO_EFFECTS_ENABLE_BALANCE)
            }
            //REVERB STATE SETTING
            fun loadReverbState(ctx: Context): Boolean {
                return loadBooleanValue(ctx, AUDIO_EFFECTS_ENABLE_REVERB, false, null)
            }
            fun saveReverbState(ctx: Context, value: Boolean) {
                saveBooleanValue(ctx, value, AUDIO_EFFECTS_ENABLE_REVERB)
            }
            //LOUDNESS ENHANCER STATE SETTING
            fun loadLoudnessEnhancerState(ctx: Context): Boolean {
                return loadBooleanValue(ctx, AUDIO_EFFECTS_ENABLE_LOUDNESS_ENHANCER, false, null)
            }
            fun saveLoudnessEnhancerState(ctx: Context, value: Boolean) {
                saveBooleanValue(ctx, value, AUDIO_EFFECTS_ENABLE_LOUDNESS_ENHANCER)
            }
        }
    }
    ...
    class Settings {
        companion object {
            ...
            fun loadIsFirstTimeOpenApp(ctx: Context): Boolean {
                return loadBooleanValue(ctx, SETTINGS_FIRST_TIME_LOADING, true, null)
            }
            fun saveIsFirstTimeOpenApp(ctx: Context, value: Boolean) {
                saveBooleanValue(ctx, value, SETTINGS_FIRST_TIME_LOADING)
            }
        }
    }
