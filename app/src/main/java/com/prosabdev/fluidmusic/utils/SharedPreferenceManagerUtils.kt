...
abstract class SharedPreferenceManagerUtils {
    class Player {
        companion object {
            //Current song value
            fun loadCurrentPlayingSong(context: Context, sharedPreferences: SharedPreferences? = null): CurrentPlayingSongSP? {
                if(sharedPreferences != null){
                    ...
                    val tempItemType = object : TypeToken<CurrentPlayingSongSP>() {}.type
                    Log.i(ConstantValues.TAG, "CurrentPlayingSong loaded !")
                    return tempGson.fromJson<CurrentPlayingSongSP>(tempItem, tempItemType)
                }
                val tempGson: Gson = Gson()
            ...
            fun saveCurrentPlayingSong(context: Context, currentPlayingSongSP: CurrentPlayingSongSP) {
                ...
                val tempGson: Gson = Gson()
                val tempJson: String = tempGson.toJson(currentPlayingSongSP)
