...
import com.prosabdev.common.models.playlist.PlaylistItemView
import com.prosabdev.fluidmusic.R
import com.prosabdev.fluidmusic.databinding.ItemPlaylistAddSongBinding

class PlaylistItemViewAdapter(
    private val mListener: OnItemClickListener
) : ListAdapter<PlaylistItemView, PlaylistItemViewAdapter.PlaylistItemViewHolder>(
    PlaylistItemView.diffCallback){
    ...
    class PlaylistItemViewHolder(
        ...
        fun updateUI(playlistItemView: PlaylistItemView){
            ...
            mItemPlaylistAddSongBinding.textSubtitle.text = "${playlistItemView.numberTracks} songs | ${com.prosabdev.common.utils.FormattersAndParsersUtils.formatSongDurationToString(playlistItemView.totalDuration)} min"
