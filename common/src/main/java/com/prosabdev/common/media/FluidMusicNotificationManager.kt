 ...
 */
internal class FluidMusicNotificationManager(
    ...
    init {
        ...
        with (builder) {
            ...
            setStopActionIconResourceId(R.drawable.close)
        }
        notificationManager = builder.build()
        notificationManager.setMediaSessionToken(sessionToken)
        notificationManager.setSmallIcon(R.drawable.ic_fluid_music_icon_with_padding)
    ...
    companion object {
        const val NOW_PLAYING_CHANNEL_ID = "NOW_PLAYING_CHANNEL_ID"
        const val NOW_PLAYING_NOTIFICATION_ID = 0xb339 // Arbitrary number used to identify our notification
        const val NOTIFICATION_LARGE_ICON_SIZE = 144 // px

        private val glideOptions = RequestOptions()
            .fallback(R.drawable.ic_fluid_music_icon_with_padding)
